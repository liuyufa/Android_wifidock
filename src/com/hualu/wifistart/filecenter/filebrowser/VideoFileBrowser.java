...
import com.hualu.wifistart.VideoViewDemo;
...
public class VideoFileBrowser extends Browser implements
	...
	private final int MENU_LOCK = MENU_FIRST + 5;
	private final int MENU_UNLOCK = MENU_FIRST + 10;
	...
	public VideoFileBrowser(Context context) {
		...
		if (!onResume) {
			QueryData((topDir), true, FileFilter.VIDEO);
			onResume = true;
		}
	}

	public VideoFileBrowser(Context context, String path) {
		super(context);
		mViewMode = ViewMode.LISTVIEW;
		initView();
	...
	public void QueryData() {
		super.QueryData(topDir, true, FileFilter.VIDEO);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		clickFileItem("video", fileItem);// zhaoyu0401
	}
	 ...
	 * //QueryData(parentPath); QueryData(parentPath, true, FileFilter.VIDEO);
	 ...
	 * true, FileFilter.VIDEO); refreshData(); currFolder =
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		// xuw add for filelock 2014/12/08
...
//								editor.commit();
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		 ...
		 * 
		 * //menu.add(1, MENU_PASTE, Menu.NONE, R.string.menu_paste); }
		 */
		return true;
	}
