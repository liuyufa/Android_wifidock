 ...
 */
public class HuzAlertDialog extends AlertDialog implements DialogInterface {
    private HuzAlertController mAlert;

    protected HuzAlertDialog(Context context) {
        this(context, R.style.My_Theme_Dialog_Alert);
    }

    protected HuzAlertDialog(Context context, int theme) {
        super(context, theme);
        mAlert = new HuzAlertController(context, this, getWindow());
    }

    protected HuzAlertDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public static class Builder extends AlertDialog.Builder {
        ...
        /**
         * Constructor using a context for this builder and the {@link HuzAlertDialog} it creates.
         */
        ...
        /**
         * Creates a {@link HuzAlertDialog} with the arguments supplied to this builder. It does not
         * {@link Dialog#show()} the dialog. This allows the user to do any extra processing
         * before displaying the dialog. Use {@link #show()} if you don't have any other processing
         * to do and want this to be created and displayed.
         */
        public HuzAlertDialog create() {
            final HuzAlertDialog dialog = new HuzAlertDialog(P.mContext);
        ...
        /**
         * Creates a {@link HuzAlertDialog} with the arguments supplied to this builder and
