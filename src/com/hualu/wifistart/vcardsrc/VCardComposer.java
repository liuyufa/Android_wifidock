...
import com.hualu.wifistart.vcardsrc.CharsetUtils;
...
public class VCardComposer {
    ...
    private String createOneEntryInternal(final String contactId,
        ...
        try {
            final Uri uri = RawContactsEntity.CONTENT_URI.buildUpon().appendQueryParameter("for_export_only", "1")//Data.FOR_EXPORT_ONLY zhaoyu
                    .build();
