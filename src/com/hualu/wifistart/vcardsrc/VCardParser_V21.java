 ...
 */
package com.hualu.wifistart.vcardsrc;

import com.hualu.wifistart.vcardsrc.exception.VCardAgentNotSupportedException;
import com.hualu.wifistart.vcardsrc.exception.VCardException;
import com.hualu.wifistart.vcardsrc.exception.VCardInvalidCommentLineException;
import com.hualu.wifistart.vcardsrc.exception.VCardInvalidLineException;
import com.hualu.wifistart.vcardsrc.exception.VCardNestedException;
import com.hualu.wifistart.vcardsrc.exception.VCardVersionException;
...
public class VCardParser_V21 extends VCardParser {
    ...
    private static final HashSet<String> sKnownTypeSet = new HashSet<String>(
            Arrays.asList("AVI","FLV","F4V","MPG","MP4","RMVB",
    ...
    protected boolean isValidPropertyName(String propertyName) {
        if (!(sAvailablePropertyNameSetV21.contains(propertyName.toUpperCase(Locale.getDefault())) ||
    ...
    protected boolean isValidEncoding(String encoding) {
        return sAvailableEncodingV21.contains(encoding.toUpperCase(Locale.getDefault()));
    }
    ...
    protected boolean parseItem() throws IOException, VCardException {
        ...
        String propertyName = propertyNameAndValue[0].toUpperCase(Locale.getDefault());
    ...
    protected void handleParams(String params) throws VCardException {
        ...
        if (strArray.length == 2) {
            final String paramName = strArray[0].trim().toUpperCase(Locale.getDefault());
