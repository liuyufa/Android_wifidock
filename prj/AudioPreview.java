...
public class AudioPreview extends Activity implements OnPreparedListener, OnErrorListener, OnCompletionListener
{
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        switch (what) {
        case MediaPlayer.MEDIA_ERROR_SIGNAL_WEAK:
            Toast.makeText(this, R.string.playback_failed_signal_weak, Toast.LENGTH_SHORT).show();
            break;
        default:
            Toast.makeText(this, R.string.playback_failed, Toast.LENGTH_SHORT).show();
            break;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, OPEN_IN_MUSIC, 0, getResources().getString(R.string.open_in_music));
        return true;
    }
